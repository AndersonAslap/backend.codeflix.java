...
public class CategoryTest {
    ...
    @Test
    public void givenAnInvalidNameLengthLessThanThree_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
    ...
    public void givenAnInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        final String expectedName = """
            A constante necessidade de adaptação das empresas diante das rápidas transformações tecnológicas e 
            sociais exige não apenas mudanças pontuais em processos internos, mas também uma reestruturação 
            estratégica capaz de alinhar valores organizacionais, práticas de gestão e inovação contínua, 
            garantindo assim a competitividade sustentável a longo prazo.
            """;
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = true;
        final var expectedErrorMessage = "'name' must be between 3 and 255 characters";
